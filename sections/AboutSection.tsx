...
export default function About() {
  ...
  return (
    <motion.section
      id="about-section"
      className="flex flex-col items-start justify-start gap-12 py-20"
    >
      ...
      <div className="flex flex-col items-center sm:justify-center justify-stretch sm:flex-row">
        <div className="flex flex-col  sm:pr-[10%] items-center justify-between w-full h-full gap-10 pb-6 border-b-2 sm:w-1/2 sm-h-full sm:pb-0 sm:border-b-0 sm:border-r-2 border-textlightmode dark:border-accentdarkmode">
          <div className="border-2 border-solid rounded-full w-60 border-textlightmode dark:border-accentdarkmode sm:w-full aspect-square"></div>
        ...
        <div className="flex items-stretch w-full h-full pt-6 justify-stretch sm:items-center sm:w-1/2 sm:pl-[10%] sm:pt-0 pageText pageText-bodytext">
